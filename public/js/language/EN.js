const EN = {
    ...
    team_section7_desc:"Master of Enterprise Risk Management from Johns Hopkins University; She participated in the case analysis several times and came up with the commercialization plan for a University owned patent during her school years. She has rich experience in analyzing and consulting. She participated in multiple program development of alliance chain products, and has experience for designing financial products. She is now responsible for the operation optimization and market development of Themis.",
    ...
    ourteam_section14_desc:"Marina holds a BSc (Hons.) in Law and French from the University of Kent and currently works at a leading tech firm in the City. She is passionate about disruptive technology and its social, as well as economic, impact. Marina is following closely the emerging regulations applicable to blockchain companies in addition to developments in data protection legislation. She has commercial background and experience in compliance, regulation and strategy and is currently working on several cryptocurrency projects. Before her current role Marina, worked for the legal team of the global asset management company, Schroders and has spent a short time working in Beijing.",

    ourteam_section15_name:"Miles Benham",
    ourteam_section15_desc:"Miles is the managing director of MannBenham Advocates Limited an Isle of Man legal practice. Admitted to the Manx Bar on the 25th September 1996 Miles is an Isle of Man Advocate, English Solicitor (non practising), Notary Public and a Commissioner for Oaths. Miles is on the board of the Isle of Man Chamber of Commerce and was one of the founders and the legal adviser to the Manx Digital Currency Association. Miles is personally recommended by the Legal 500.Mann Benham are winners of the Isle of Man  Law Firm of the Year in the City Wealth IFC awards 2017.",
    ourteam_section16_name:"John Middleton",
    ourteam_section16_desc:"John Middleton a Chartered Company Secretary, with over 15 years in the fiduciary sector in a number of director level roles including Compliance and MLRO in the Isle of Man and elsewhere. He has experience in a number of complex and time sensitive transactions, in a number of sectors including Commercial Property, Shipping, and FinTech both reported and unreported. John also has a degree in Applied Computing, and has formerly worked in software development and project management roles, and works with a number of companies in the blockchain/crypto space.",
    ourteam_section17_name:"Carly Stratton",
    ourteam_section17_desc:"Carly was admitted to the Manx Bar on 8th January 2008 having studied law at Durham University and completing her Legal Practice Course at the Oxford Institute of Legal Practice. Carly is a director of MannBenham Advocates Limited, a Commissioner for Oaths and heads up their commercial department. Carly is also a committee member of the Isle of Man Wealth & Fund Services Association. Carly is personally recommended by the Legal 500 and is a director of a leading Isle of Man equine charity.",
    ourteam_section15_pic:"/public/img/MILES BENHAM.png",
    ourteam_section16_pic:"/public/img/JOHN MIDDLETON.png",
    ourteam_section17_pic:"/public/img/CARLY STRATTON.png",
